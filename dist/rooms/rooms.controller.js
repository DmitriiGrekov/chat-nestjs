...
let RoomsController = class RoomsController {
    constructor(roomsService, redis) {
    ...
    async findAll(userId, optionsDto) {
        const params = (0, search_1.prepareParams)(optionsDto, { users: { some: { id: userId } } }, { include: { users: Object.assign({}, users_controller_1.userSelect), message: true } });
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, options_dto_1.OptionsDto]),
    __metadata("design:returntype", Promise)
...
RoomsController = __decorate([
    ...
    __metadata("design:paramtypes", [rooms_service_1.RoomsService, ioredis_1.default])
], RoomsController);
